  ...
  virtualisation.oci-containers.containers = {
    jellyseerr = {
      ...
      extraOptions = [
        ...
        "-l=homepage.href=https://jellyseerr.${vars.defaultDomain}"
    ...
    prowlarr = {
      ...
      extraOptions = [
        ...
        "-l=homepage.href=https://prowlarr.${vars.defaultDomain}"
    ...
    sonarr = {
      ...
      extraOptions = [
        ...
        "-l=homepage.href=https://sonarr.${vars.defaultDomain}"
    ...
    radarr = {
      ...
      extraOptions = [
        ...
        "-l=homepage.href=https://radarr.${vars.defaultDomain}"
        "-l=homepage.description=Monitor RSS for new episodes of TV shows"
        "-l=homepage.weight=5"
    ...
    bazarr = {
      ...
      extraOptions = [
        ...
        "-l=homepage.href=https://bazarr.${vars.defaultDomain}"
